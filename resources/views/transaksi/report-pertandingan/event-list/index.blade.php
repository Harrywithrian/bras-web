<x-base-layout>
    ...
    <div class="card shadow-sm" id="main-layout">
        ...
        <div class="card-body">
            ...
            @include('transaksi.report-pertandingan.event-list.search')
    ...
    @section('scripts')
        <script src="{{asset('demo1/js/transaksi/report-pertandingan/index-event.js')}}"></script>
