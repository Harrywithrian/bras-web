<x-base-layout>
    <?php $title = 'Report Pertandingan Event ' . $event->nama ?>
    ...
    <div class="card shadow-sm" id="main-layout">
        ...
        <div class="card-body">
            ...
            @include('transaksi.report-pertandingan.search')
    ...
    @section('scripts')
        <script src="{{asset('demo1/js/transaksi/report-pertandingan/index.js')}}"></script>
