<x-base-layout>
    ...
    <?php
    $title = 'Edit Game Management : ' . $wst->name;
    $i = 1;
    ...
    ?>
        ...
        <ol class="breadcrumb text-muted fs-6 fw-bold mb-5">
            ...
            <li class="breadcrumb-item pe-3"><a href="{{ route('game-management.show', [$id, $wasit]) }}" class="pe-3"> Game Management : {{ $wst->name }} </a></li>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('game-management.update', [$id, $wasit]) }}">
            @csrf
                ...
                <div class="form-group float-end">
                    ...
                    <a href="{{ route('game-management.show', [$id, $wasit]) }}" class="btn btn-secondary"> Kembali </a>
                </div>
            </form>
        </div>
    </div>
