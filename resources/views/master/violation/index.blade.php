<x-base-layout>
    ...
    <div class="card shadow-sm" id="main-layout">
        ...
        <div class="card-body">
            ...
            @include('master.violation.search')

            <div class="row">
                <div class="col-12">
                    <div class="float-end mb-5">
                        <a class="btn btn-xs btn-primary" href="{{ route('violation.create') }}"> Tambah data </a>
                    </div>
                </div>
            </div>
    ...
    @section('scripts')
        <script src="{{asset('demo1/js/master/violation/index.js')}}"></script>
