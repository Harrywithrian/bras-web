<x-base-layout>
    <?php $title = 'Template Game Management' ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="float-start mb-5">
                        <a class="btn btn-xs btn-secondary" href="{{ route('m-game-management.preview') }}"> Preview </a>
                    </div>

                    <div class="float-end mb-5">
                        <a class="btn btn-xs btn-primary" href="{{ route('m-game-management.create-header') }}"> Tambah Header </a>
                        <a class="btn btn-xs btn-success" href="{{ route('m-game-management.create-content') }}"> Tambah Content </a>
                    </div>
                </div>
            </div>
    ...
    @section('scripts')
        <script src="{{asset('demo1/js/master/m-game-management/index.js')}}"></script>
