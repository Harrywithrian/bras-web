<x-base-layout>
    ...
    <ol class="breadcrumb text-muted fs-6 fw-bold mb-5">
        ...
        <li class="breadcrumb-item pe-3"><a href="{{ route('profile.index', $model->id) }}" class="pe-3">Profile</a></li>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('profile.store-lisensi', $model->id) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-5">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="nomor_lisensi" class="form-control" name="nomor_lisensi" value="{{ old('nomor_lisensi') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-control" data-placeholder="Pilih Lisensi ..." id="jenis_lisensi" name="jenis_lisensi">
                                ...
                                @foreach($lisensi as $item)
                                    <option value="{{ $item['id'] }}" {{(old('jenis_lisensi') == $item['id']) ? 'selected' : '';}}>@if($item['type'] == 1) Wasit - @else Pengawas - @endif {{ $item['license'] }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row mb-5">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="tanggal_aktif" id="tanggal_aktif" value="{{old('tanggal_aktif')}}">
                ...
                <div class="row mb-5">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="tanggal_expired" id="tanggal_expired" value="{{old('tanggal_expired')}}">
                ...
                <div class="form-group mt-5 float-end">
                    ...
                    <a href="{{ route('profile.index', $model->id) }}" class="btn btn-secondary"> Kembali </a>
                </div>
            </form>
        </div>
    </div>
