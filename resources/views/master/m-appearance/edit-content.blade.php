<x-base-layout>
    ...
    $headerId = (old('header')) ? old('header') : $model->id_m_appearance;
    ?>
    ...
    <ol class="breadcrumb text-muted fs-6 fw-bold mb-5">
        ...
        <li class="breadcrumb-item pe-3"><a href="{{ route('m-appearance.show', $model->id) }}" class="pe-3">{{ $model->nama }}</a></li>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('m-appearance.update-content', $model->id) }}">
                @csrf
