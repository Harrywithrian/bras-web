<x-base-layout>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            @if($model->level == 1)
                <a href="{{ route('m-appearance.edit-header', $model->id) }}" class="btn btn-warning"> Edit </a>
            @else
                <a href="{{ route('m-appearance.edit-content', $model->id) }}" class="btn btn-warning"> Edit </a>
            @endif
                            ...
                            success: function (response) {
                                if (response.status == 200) {
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            window.location.replace("/m-appearance/index");
                                        }
                                    });
                                } else {
                                    Swal.fire({
