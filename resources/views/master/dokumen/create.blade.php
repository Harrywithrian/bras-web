            ...
            <form method="post" action="{{ route('dokumen.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="nama_dokumen" class="form-control" name="nama_dokumen" value="{{ old('nama_dokumen') }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea id="deskripsi" class="form-control" name="deskripsi" value="{{ old('deskripsi') }}"></textarea>
