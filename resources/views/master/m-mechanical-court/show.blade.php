<x-base-layout>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            @if($model->level == 1)
                <a href="{{ route('m-mechanical-court.edit-header', $model->id) }}" class="btn btn-warning"> Edit </a>
            @else
                <a href="{{ route('m-mechanical-court.edit-content', $model->id) }}" class="btn btn-warning"> Edit </a>
            @endif
