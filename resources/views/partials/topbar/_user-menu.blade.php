...
<?php
    ...
    $userInfo = \App\Models\UserInfo::where('user_id', '=', $user->id);
//    $foto = \App\Models\Transaksi\TFile::find($userInfo->avatars);
?>
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="symbol symbol-50px me-5">
                <img alt="Logo" src="{{ auth()->user()->avatar_url }}" width="100%">
            </div>
            <!--end::Avatar-->
